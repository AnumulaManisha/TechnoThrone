package com.example.technothrone;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        enterTeam.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ( teamNo.equals("25") && password.equals("manisha"))
                {
                    ...
                    check = FirebaseDatabase.getInstance().getReference().child("users").child(teamNo).child("signedin");
                    ...
                    check.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            if (s.equals("false")) {
                                teamPasswords = FirebaseDatabase.getInstance().getReference().child("users").child(teamNo).child("password");
                                ...
                                teamNumber.setError("already some person from your kingdom entered");
