...
public class questionPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        balanceofteam=FirebaseDatabase.getInstance().getReference().child("users").child(teamNumber).child("balance");
        ...
        positionofteam=FirebaseDatabase.getInstance().getReference().child("users").child(teamNumber).child("position");
